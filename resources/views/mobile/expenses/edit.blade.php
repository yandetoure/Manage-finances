                    ...
                    <div
                        ...
                        @foreach($categories as $category)
                            <label style="flex-shrink: 0; cursor: pointer;">
                                <input type="radio" name="category_id" value="{{ $category->id }}" required {{ $expense->category_id == $category->id ? 'checked' : '' }} style="display: none;"
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="position: relative;">
                        <input type="number" step="0.01" name="amount" value="{{ $expense->amount }}" required
                            placeholder="0.00" class="input-modern"
                ...
                <div
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 10px;">
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div
                                style="width: 35px; height: 35px; background: rgba(239, 68, 68, 0.1); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #ef4444;">
                    ...
                    <div id="frequency-container"
                        style="{{ $expense->is_recurrent ? 'display: block;' : 'display: none;' }} margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.05);">
                        <label class="text-muted"
                        ...
                        <select name="frequency" class="input-modern"
                            ...
                            <option value="weekly" {{ $expense->frequency == 'weekly' ? 'selected' : '' }}>Hebdomadaire
                            </option>
